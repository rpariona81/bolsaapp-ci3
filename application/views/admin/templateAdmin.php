...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <div id="main-wrapper">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <!--<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                                <a class="dropdown-item" href="pages-profile.html"><i class="align-middle me-1" data-feather="user"></i> Mi perfil</a>
                                <a class="dropdown-item" href="#"><i class="align-middle me-1" data-feather="pie-chart"></i> Cambiar clave</a>
        ...
        <!-- ============================================================== -->
        <aside class="left-sidebar" id="#sidebarToggle">
            <!-- Sidebar scroll-->
            ...
            <div class="sidebar-footer text-center">
                <a class="waves-effect waves-light pull-right btn btn-block" data-toggle="tooltip" data-placement="bottom" title="Cerrar sesión" href="/logout">Salir &nbsp;<i class="mdi mdi-power"></i></a>
            </div>
            <!-- End Bottom points-->
        </aside>
        <!-- ============================================================== -->
