...
INSERT INTO `t_careers` VALUES ('3', 'Diseño de Modas', 'Q3286-3-004', 'FARMACIA TECNICA', 'FARMACIA TECNICA', null, null, null);
INSERT INTO `t_careers` VALUES ('4', 'Gastronomía', null, 'TECNOLOGIA PESQUERA Y ACUICOLA', 'DESARROLLO PESQUERO Y ACUICOLA', null, null, null);
INSERT INTO `t_careers` VALUES ('5', 'Mecatrónica Automotriz', 'A0203-3-001', 'DESARROLLO PESQUERO Y ACUICOLA', 'DESARROLLO PESQUERO Y ACUICOLA', null, null, null);
...
CREATE TABLE `t_offersjob` (
  ...
  `career_id` int(10) unsigned DEFAULT NULL,
  `email_employer` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `turn_horary` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` tinyint(3) unsigned NOT NULL DEFAULT 1,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
